...
dbBlogs.once("value", function (blogs) {
    ...
    if (blogs.exists()) {
        ...
        blogs.forEach(function (singleblog) {
            ...
            m_body.setAttribute("class", "modal-body");
            m_body.setAttribute("id","m-body");
            ...
            mf_div_cmt.setAttribute("class", "col-8 my-div-tag");
            ...
            blog_category.setAttribute("id","mt-category")
